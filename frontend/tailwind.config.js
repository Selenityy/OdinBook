...
module.exports = {
  ...
  theme: {
    ...
    gridTemplateColumns: {
      ...
      XLuserLayout: "1fr repeat(2, minmax(min-content, max-content)) repeat(6, 0.5fr) repeat(2, minmax(min-content, max-content)) 1fr",
      LuserLayout: "repeat(2, minmax(min-content, max-content)) repeat(7, 1fr) repeat(3, minmax(min-content, max-content))",
      MDuserLayout: "repeat(2, minmax(min-content, max-content)) repeat(4, 1fr) repeat(2, minmax(min-content, max-content))",
