...
test("should accept an incoming friend request", async () => {
  const res = await request(app)
    .post(`/user/${userId}/acceptFriendRequest/${friendUsername}`)
  ...
  expect(actualUser.friends).toEqual(
    expect.arrayContaining([expect.objectContaining({ _id: friendUserId })])
  );
